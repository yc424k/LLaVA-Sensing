...
'''
    ...
    with open(
        "/home/yc424k/LLaVA-Sensing/stage0_data_processing/data_generation/dataset_reader.py",
        'w'
    ) as f:
        f.write(reader_code)
...
def main():
    ...
    input_file = "/home/yc424k/LLaVA-Sensing/stage0_data_processing/data_generation/data/novel_dataset.json"
    output_dir = "/home/yc424k/LLaVA-Sensing/stage0_data_processing/data_generation/data/chunks"
    chunk_size = 100
